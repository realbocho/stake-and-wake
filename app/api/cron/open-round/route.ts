...
import { TonClient, WalletContractV5R1, internal, toNano, Address, beginCell, SendMode } from "@ton/ton";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ ok: true, skipped: false, roundId, closesAt, seqno, walletAddress });
  } catch (cause) {
